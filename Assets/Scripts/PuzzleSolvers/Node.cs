...
namespace Assets.Scripts.PuzzleSolvers
{
    public class Node
    {
        ...
        internal static readonly Vector2[] mDirections = new[] { Vector2.left, Vector2.right, Vector2.up, Vector2.down };
        ...
        internal Node MoveTo(Vector2 dir, Direction direction)
        {
