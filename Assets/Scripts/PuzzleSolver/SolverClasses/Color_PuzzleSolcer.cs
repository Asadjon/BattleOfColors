...
namespace Assets.Scripts.PuzzleSolvers.SolverClasses
{
    public sealed class Color_PuzzleSolver : PuzzleSolver
    {
        ...
        protected override SerializeblePuzzleSolver GetMyPuzzleSolver() =>
            new SerializebleColor_PuzzleSolver { PartIndex = mPartIndex };

        public override PuzzleSolver Set(SerializeblePuzzleSolver solver)
        {
            base.Set(solver);
            if (!(solver is SerializebleColor_PuzzleSolver colorSolver)) return this;
            SetPartOfGoal = (sbyte)colorSolver.PartIndex;
    ...
    [Serializable]
    class SerializebleColor_PuzzleSolver : SerializeblePuzzleSolver
    {
